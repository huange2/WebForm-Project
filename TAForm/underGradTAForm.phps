<?php
    ...
    /* Name:Erica Huang
     * Date: 1-28-2015
     * File: underGradTAForm.php
     * Purpose: Provide a form for potential undergraduate TA's
     */
    ...
    function createTable($array, $type, $id, $choices, $a, $ref) { 
        $labelId = 0;
        $length = count($array);
        for($counter=0; $counter < $length; $counter++) {
            ...
            for($i=0; $i < $choices; $i++){
                echo " <td class='customBox'><input type=".'"'.$type.'" '."id=".'"'.$labelId.$id.'"'." name=".'"'.$id.$counter.$a.'"'." value=".'"'.$ref[$i].'"'."><label for="."'".$labelId.$id."'>"."</label></td>\n";
                $labelId++;
            }
        }
    }
...
<html lang="en">
    ...
    <body onload="init()">
        <div class="main">
            <div class="header">
                <h1>WWU CS Undergrad TA Application Form</h1>
            ...
            <form id="UTAForm" action="processTAForm.php" method="POST">
                 <fieldset id="part1">
                 ...
                 <fieldset id="part3">
                     <h4>  If you have any course assignment preferences, list them below.  Use the “No Way” column to indicate classes that you do not want or for which you do not feel qualified.</h4>
                     <table>
                         <tr>
                              <th>Preferences</th>
                              <th>1st choice</th>
                         ...
                         <?php createTable($classes, "radio", "row", 4, "", $classRef); ?>
                     </table>
                 </fieldset>
                 <fieldset id="part4">
                     <h4>Please indicate by clicking the boxes the times you will NOT be available</h4>
                     <table id="customBox">
                         <tr>
                              <th>Days of Week</th>
                              <th>Monday</th>
                 ...
                 <input id="submitB" type="submit" value="Submit">
                  <input type="hidden" name="classCnt" value="<?php echo count($classes); ?>">
                  <input type="hidden" name="formType" value="UTA">
                 ...
                 <a href="http://sw.cs.wwu.edu/~huange2/cs300/TAForm/underGradTAForm.php">
                     <div id="home"> 
                         <p>RESET</p>
